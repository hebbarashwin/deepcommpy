...
def save_weights(h, g, coding_scheme, channel_type, set_model, alpha, nn_eq, training_batch_size, lr, eb_n0_train_lo, eb_n0_train_hi, offline_tr_data, max_iter, steps, relu, adapt_tr, freeze_wt, ff, models):
	...
	-force_all_zero 0 -channel_type " + channel_type + " -set_model " + set_model + " -alpha " + alpha + " -nn_eq " + nn_eq + " -coding_scheme \
...
H_filename = ['parity/BCH_63_36.alist']
G_filename = ['parity/G_BCH_63_36.gmat']
				...
				for coding_scheme in coding_scheme_list:
					for channel_type in channel_type_list:
						...
						if (coding_scheme == "BCH"):
							...
							save_weights(h, g, coding_scheme, channel_type, set_model, alpha, nn_eq, training_batch_size, lr, eb_n0_train_lo_tr, eb_n0_train_hi_tr, offline_tr_data, mi, steps_tr, relu, adapt_tr, freeze_wt, ff, saved_models_new)
